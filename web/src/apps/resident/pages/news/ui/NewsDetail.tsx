// // plugins
// import { CalendarDays, Loader2, MessageCircle, Pin } from "lucide-react";
//
// // types
...
// }
//
// export function NewsDetail({ selected, comments, loading }: Props) {
//     if (!selected) {
//         return (
//             <div className="news-detail__empty">
//                 <span className="news-detail__empty-icon">📰</span>
//                 <p>Выберите новость из списка</p>
//             </div>
//         );
//     }
//
...
//             {/* Изображения */}
//             {images.length > 0 && (
//                 <div className="news-detail__images">
//                     {images.map((img, i) => (
//                         <img
//                             key={i}
...
//             {/* Документы */}
//             {docs.length > 0 && (
//                 <div className="news-detail__docs">
//                     <h3 className="news-detail__docs-title">
//                         📎 Вложения
//                     </h3>
//
//                     {docs.map((doc, i) => (
...
//                             target="_blank"
//                             rel="noreferrer"
//                             className="news-detail__doc-link"
//                         >
...
//
//                 {comments.length === 0 ? (
//                     <p className="news-detail__no-comments">
...
//                             <li
//                                 key={c.id}
//                                 className="news-detail__comment"
//                             >
//                                 {/* Аватар */}
                            ...
                            >
                                ...
                                <div className="news-detail__doc-body">
                                    <span className="news-detail__doc-name">
                                        {getFileName(doc.fileUrl, doc.name)}
                                    </span>

// WorkflowSection — секция "Как это работает" /management — Горизонтальный timeline на десктопе, вертикальный на мобильном — Нумерованные шаги с соединительными линиями между ними

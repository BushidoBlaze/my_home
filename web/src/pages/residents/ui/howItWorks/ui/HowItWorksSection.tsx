// HowItWorksSection — секция "Как начать" страницы /residents — 3 карточки в ряд с большими стилизованными цифрами, — заголовками и описаниями. Между карточками — стрелки.
